...
- `Affiliate`: `name`, `lastname`, `address`, `company` · `Beneficiary`: `name` · `Counselor`: `name`, `lastname`, `address` · `Doctor`: `name`, `lastname`, `address`, `secretary_name` · `Agreement`: `name` · `Specialty`: `name` · `Appointment`: `name`, `address` · `MembershipForm`: `name`, `lastname`, `address`, `seller` · `MembershipFormBeneficiary`: `name` · `Contact`: `name`, `subject`, `comment` · `AffiliateNote`: `body` · `User` (franquicias): `name`, `contact`, `address`.
